...
func (r *RetrySimulator) ExecuteSingleSimulation() ([]int64, error) {
	...
	var _, err = rtyTemplate.Execute(&FailinretryCallback{})
	if err != nil {
...
type FailinretryCallback struct {
}

func (f FailinretryCallback) DoWithRetry(content retry.RtyContext) interface{} {
	panic("FailinretryException")
}
